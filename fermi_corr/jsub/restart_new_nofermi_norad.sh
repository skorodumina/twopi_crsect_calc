...
echo "JOBNAME: fermicorr_nofermi_norad_${i}" >>jsub_new
...
echo "OUTPUT_DATA: out_noferm_norad_part_${z}.root" >>jsub_new
echo "OUTPUT_TEMPLATE:  /mss/clas/e1e/production/simulation_2pi/sim_skorodum_Aug2016/fermicorr/nofermi_norad_fin_prog_nphb_varset/out_noferm_norad_part_${z}.root" >>jsub_new
...
if (!((-e /mss/clas/e1e/production/simulation_2pi/sim_skorodum_Aug2016/fermicorr/nofermi_norad_fin_prog_nphb_varset/out_noferm_norad_part_${z}.root))) then
echo $i
#jremove /mss/clas/e1e/production/simulation_2pi/sim_skorodum_Aug2016/nt10_cont/nt10_Aug16_newFrad_${i}.root
#rm -f /cache/mss/clas/e1e/production/simulation_2pi/sim_skorodum_Aug2016/nt10_cont/nt10_Aug16_newFrad_${i}.root
